...
/*!*******************************!*\
  !*** ./src/actions/albums.js ***!
  \*******************************/
/*! exports provided: GET_ALBUMS, GET_ALBUM, CREATE_ALBUM, ADD_IMAGE, POPUP_TOGGLE, getAlbums, findAlbum, createAlbum, addImage, popupToggle, deleteImage, deleteAlbum */
...
const deleteImage = imageData => {
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${ROOT_URL}/delete-image/${albumId}`, {
      image
    }).then(res => {
      disptach({
        type: DELETE_IMAGE,
...
const deleteAlbum = imageData => {
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${ROOT_URL}/delete-album/${albumId}`, {
      image
    }).then(res => {
      disptach({
        type: DELETE_IMAGE,
...
//# sourceMappingURL=main.748ad9ef297d02841290.hot-update.js.map