    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        let {
          imageToDelete,
          albumId
        } = ctx.request.body; // const album = await AlbumModel.findOne({ _id: albumId });
        // console.log("album", album);
        // const albumArray = album;
        // const imageResult = albumArray.find(
        //   album => imageToDelete === album.images._id
        // );
...
//# sourceMappingURL=main.1a5c52185b118fe53107.hot-update.js.map