  ...
  middleware() {
    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        console.log("typeof album.images", typeof album.images);

        for (let i = 0; i < currentAlbum.length; i++) {
          console.log("currentAlbum[i]", currentAlbum[i]);
...
//# sourceMappingURL=main.80fc0db000261a1c3d39.hot-update.js.map