...
class Album extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    ...
    _defineProperty(this, "handleDeleteClick", imageId => {
      this.props.popupToggle(imageId);
    });

    _defineProperty(this, "handleImagePopup", () => {});
  }
  ...
  render() {
    if (this.props.togglePopup === true) {
      ...
      onClick: () => this.handleImagePopup(image)
...
//# sourceMappingURL=main.c73f09c82e24313abde6.hot-update.js.map