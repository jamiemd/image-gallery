...
Object(fusion_core__WEBPACK_IMPORTED_MODULE_0__["createPlugin"])({
  middleware() {
    ...
    return async (ctx, next) => {
      console.log("ctx.path", ctx.path); // get all albums
      ...
      } else if (ctx.method === "GET" && ctx.path.startsWidth("/api/findAlbum/")) {
        let {
          id
        } = ctx.request.body;
        console.log("id", id);
...
//# sourceMappingURL=main.168b61a164082c971e8b.hot-update.js.map