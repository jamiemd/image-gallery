      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        for (let i = 0; i < imagesArray.length; i++) {
          ...
          if (idString === imageToDelete) {
            imagesArray.splice(1, i);
          }
        }

        console.log("imagesArray.length", imagesArray.length); // const result = await AlbumModel.findOneAndUpdate(
        //   { _id: albumId },
        //   {
...
//# sourceMappingURL=main.688c0ee70d55dada3705.hot-update.js.map