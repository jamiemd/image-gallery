...
const createAlbum = (name, images) => {
  ...
  const imagesArray = [];
  imagesArray.push(images.file.name);
  console.log("imagesArray", imagesArray);
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${ROOT_URL}/create-album`, images, {
      name
    }).then(res => {
      console.log("res", res);
      dispatch({
...
//# sourceMappingURL=main.15533521a744250f9beb.hot-update.js.map