...
const createAlbum = (name, images) => {
  ...
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${ROOT_URL}/create-album`, imagesArray, name).then(res => {
      console.log("res", res);
      dispatch({
        type: CREATE_ALBUM,
        payload: res.data
...
//# sourceMappingURL=main.219a07eb2f57c36f4e6c.hot-update.js.map