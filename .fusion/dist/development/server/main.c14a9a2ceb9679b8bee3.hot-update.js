  ...
  middleware() {
    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        const imageResult = albumArray.filter(album => imageToDelete === album.images._id); // const result = await AlbumModel.findOneAndDelete({
        //   _id: imageToDelete
        // });
        // console.log("result", result);
...
//# sourceMappingURL=main.c14a9a2ceb9679b8bee3.hot-update.js.map