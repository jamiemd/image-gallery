...
const createAlbum = (name, images) => {
  ...
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${ROOT_URL}/create-album`, name, imagesArray).then(res => {
      console.log("res", res);
      dispatch({
        type: CREATE_ALBUM,
        payload: res.data
...
//# sourceMappingURL=main.e45ce8a939829545f47a.hot-update.js.map