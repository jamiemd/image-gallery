  ...
  middleware() {
    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        const imageResult = albumArray.filter(album => imageToDelete === album.images._id);
        console.log("imageResult", imageResult); // const result = await AlbumModel.findOneAndDelete({
        //   _id: imageToDelete
        // });
        // console.log("result", result);
...
//# sourceMappingURL=main.f26c4b5b86ea90a8f38e.hot-update.js.map