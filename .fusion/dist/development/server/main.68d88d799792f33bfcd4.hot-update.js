...
class Album extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render() {
    console.log("this.props.showDeletePopup", this.props.showDeletePopup);

    if (this.props.showDeletePopup === true) {
...
//# sourceMappingURL=main.68d88d799792f33bfcd4.hot-update.js.map