...
const createAlbum = (name, images) => {
  console.log("name, images", name, images);
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${ROOT_URL}/create-album`, name, images).then(res => {
      dispatch({
        type: CREATE_ALBUM,
        payload: res.data
      });
...
//# sourceMappingURL=main.a41b27b360160d5ea8fe.hot-update.js.map