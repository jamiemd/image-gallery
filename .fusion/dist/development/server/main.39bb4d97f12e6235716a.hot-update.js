    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        for (let i = 0; i < albumArray.length; i++) {
          if (albumArray[i]._id === imageToDelete) {
            albumArray.slice(1, i);
          }
        }

        console.log("imageResult", imageResult); // find album and return album array of images
...
//# sourceMappingURL=main.39bb4d97f12e6235716a.hot-update.js.map