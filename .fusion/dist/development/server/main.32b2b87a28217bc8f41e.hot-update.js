    ...
    return async (ctx, next) => {
      ...
      if (ctx.method === "GET" && ctx.path === "/api/getAlbums") {
        ...
        for (let i = 0; i < currentAlbum.length; i++) {
          if (currentAlbum[i]._id === imageToDelete) {
            currentAlbum.slice(1, i);
          }
        }

        console.log("currentAlbum", currentAlbum); // find album and return album array of images
        // remove imagetodelete from array
        //
...
//# sourceMappingURL=main.32b2b87a28217bc8f41e.hot-update.js.map