...
Object(fusion_core__WEBPACK_IMPORTED_MODULE_0__["createPlugin"])({
  middleware() {
    ...
    return async (ctx, next) => {
      ...
      } else if (ctx.method === "PUT" && ctx.path === "/api/delete-album") {
        await parseBody(ctx, () => Promise.resolve());
        let {
          albumId
        } = ctx.request.body;
      ...
      } else if (ctx.method === "PUT" && ctx.path === "/api/delete-image") {
        await parseBody(ctx, () => Promise.resolve());
        let {
          imageToDelete,
          albumId
...
//# sourceMappingURL=main.8ba51c93566c6245a07a.hot-update.js.map