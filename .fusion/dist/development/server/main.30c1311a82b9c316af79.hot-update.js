...
/*!*******************************!*\
  !*** ./src/actions/albums.js ***!
  \*******************************/
/*! exports provided: GET_ALBUMS, GET_ALBUM, CREATE_ALBUM, ADD_IMAGE, POPUP_TOGGLE, getAlbums, findAlbum, createAlbum, addImage, popupToggle, deleteAlbum, deleteImage */
...
const deleteImage = imageId => {
  return dispatch => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${ROOT_URL}/delete-image/${imageId}`, {
      image
    }).then(res => {
      disptach({
        type: DELETE_IMAGE,
...
//# sourceMappingURL=main.30c1311a82b9c316af79.hot-update.js.map